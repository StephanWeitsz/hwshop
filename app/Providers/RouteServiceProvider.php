    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::prefix('admin')
                ->middleware(['web', 'auth', 'role:admin'])
                ->namespace($this->namespace)
                ->group(base_path('routes/web/utilities.php'));

            Route::prefix('admin')
                ->middleware(['web'])
                ->namespace($this->namespace)
                ->group(base_path('routes/web/address.php'));
            ...
            Route::prefix('admin')
                ->middleware(['web'])
                ->namespace($this->namespace)
                ->group(base_path('routes/web/product_items.php'));

            Route::prefix('admin')
                ->middleware(['web'])
                ->namespace($this->namespace)
                ->group(base_path('routes/web/product_elements.php'));
        });
    }
